...
const {sendPasswordEmail,sendWelcomeEmail,sendCompanyBlockEmail,sendStudentBlockEmail}=require("../emails/account.js")
...
router.post("/admin",async(req,res)=>{
 ...
 router.patch("/block",auth,async(req,res)=>{
    ...
    //    console.log("-------")
       ...
       sendCompanyBlockEmail(companyDetails.email)
 ...
 router.patch("/studentblock",auth,async(req,res)=>{
    ...
    //    console.log("-------")
       ...
       sendStudentBlockEmail(studentDetails.email)
